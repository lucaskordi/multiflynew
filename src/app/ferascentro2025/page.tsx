...
export default function FerasCentro2025() {
    ...
    <div className="min-h-screen bg-slate-900 text-white font-montserrat">
      ...
      <header className="sticky top-0 z-50">
        ...
        <div className="flex justify-between items-center max-w-7xl mx-auto">
          ...
          <nav className="hidden lg:flex items-center gap-8">
            ...
            <a href="#descritivo" onClick={() => setActiveTab('events')} className="text-sm text-slate-300 hover:text-yellow-400 transition-all duration-300 hover:scale-110">Descritivo</a>
      ...
      <section className="text-center py-12 px-6">
        ...
        <h2 className="text-5xl md:text-7xl font-bold mb-8">
          BOM JESUS CENTRO 2025
        </h2>
        <p className="text-slate-300 text-lg md:text-xl max-w-4xl mx-auto mb-12">
          Neste material contemplamos as respostas das principais dúvidas das famílias em relação à Formatura do Terceirão Bom Jesus Centro 2025.
        </p>
      ...
      <section id="eventos" className={`py-12 px-6 scroll-mt-12 transition-all duration-1000 ${visibleSections.has('eventos') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'}`}>
        ...
        <h2 className="text-3xl font-bold text-center mb-12">Evento da Formatura</h2>
          ...
          <div className="bg-slate-800/40 backdrop-blur-lg rounded-xl p-6 border border-slate-700/50 shadow-xl">
            ...
            <div className="flex items-center">
                  ...
                  <p><span className="font-semibold">Data:</span> 03 de Dezembro de 2025 - Quarta-feira</p>
          </div>
                <div className="flex items-center">
                  <svg className="w-5 h-5 mr-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="space-y-4">
          ...
          {/* Seção Descritivo do Baile */}
          <div id="descritivo" className={`w-full mt-12 scroll-mt-12 transition-all duration-1000 ${visibleSections.has('descritivo') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'}`} style={{ background: 'radial-gradient(circle at 50% 50%, rgba(30, 58, 138, 0.25) 0%, rgba(30, 58, 138, 0.12) 20%, rgba(30, 58, 138, 0.05) 35%, rgba(30, 58, 138, 0.01) 45%, transparent 55%)' }}>
            <div className="max-w-6xl mx-auto pt-12 pb-12">
              <h2 className="text-3xl font-bold text-center mb-12">Descritivo Baile de Formatura - BJ CENTRO 2025</h2>
              
              <div className="bg-slate-800/40 backdrop-blur-lg rounded-xl p-8 border border-slate-700/50 shadow-xl">
                <div className="space-y-8">
                  {/* Informações Gerais */}
                  <div>
                    <h3 className="text-2xl font-bold text-yellow-400 mb-4">Bom Jesus Centro 2025</h3>
                    <div className="grid md:grid-cols-2 gap-4 text-slate-300">
                      <p><span className="font-semibold text-white">Projeto Inicial Idealizado:</span> 120 Formandos</p>
                      <p><span className="font-semibold text-white">Projeto Atual:</span> 166 Formandos</p>
                    </div>
                  </div>

                  {/* Local do Evento e Custos */}
                  <div>
                    <h4 className="text-xl font-bold text-blue-400 mb-4">Local do Evento e Custos Relacionados</h4>
                    <div className="grid md:grid-cols-2 gap-4 text-slate-300">
                      <div>
                        <p className="font-semibold text-white mb-2">Salão Espaço Torres - Paraná Clube</p>
                        <ul className="space-y-1 text-sm">
                          <li>• ECAD (Direitos Autorais Do Evento)</li>
                          <li>• Gerador</li>
                          <li>• Convites Indispensáveis de Acesso</li>
                          <li>• Projeto 3D</li>
                          <li>• Pulseiras de LED</li>
                        </ul>
                      </div>
                      <div>
                        <ul className="space-y-1 text-sm">
                          <li>• Bazookas de CO2 Com Cilindro</li>
                          <li>• JetSetCO2 Sem Cilindro</li>
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-red-400 mb-4">Contratações Obrigatórias</h4>
                    <div className="grid md:grid-cols-2 gap-4 text-slate-300">
                      <ul className="space-y-1 text-sm">
                        <li>• Ambulância UTI Móvel Durante Todo O Evento</li>
                        <li>• Brigadistas (4)</li>
                      </ul>
                      <ul className="space-y-1 text-sm">
                        <li>• Seguro de Responsabilidade Civil</li>
                        <li>• Rádios de Comunicação (25)</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-green-400 mb-4">Decoração e Ambientação</h4>
                    <div className="grid md:grid-cols-2 gap-4 text-slate-300">
                      <div>
                        <ul className="space-y-1 text-sm">
                          <li>• Decoração Premium Base (Projeto Realizado em Conjunto Com A Comissão)</li>
                          <li>• Centro de Mesa Premium Base (Projeto Realizado em Conjunto Com A Comissão)</li>
                          <li>• Mobiliário Completo de Mesas, Cadeiras Cristal e Toalhas de Mesa</li>
                          <li>• Paisagismo</li>
                          <li>• Unifilas</li>
                          <li>• Púlpito</li>
                        </ul>
                      ...
                      <div>
                        <ul className="space-y-1 text-sm">
                          <li>• 5 Estúdios Fotográficos</li>
                          <li>• 3 Tvs de Bar e Sinalização</li>
                          <li>• Marcadores de Mesa</li>
                          <li>• Cardápios de Mesas</li>
                          <li>• Sinalização</li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-purple-400 mb-4">Evento 100% Open Food e Open Bar Não-Alcoólico</h4>
                    <p className="text-slate-300 mb-4">Da abertura do evento até as 4h00.</p>
                    <div className="grid md:grid-cols-2 gap-4 text-slate-300">
                      <div>
                        <p className="font-semibold text-white mb-2">Open Bar Não-Alcoólico:</p>
                        <ul className="space-y-1 text-sm">
                          <li>• Água Com e Sem Gás</li>
                          <li>• 2 Sabores de Sucos e Refrigerantes Normal e Zero</li>
                        </ul>
                      </div>
                      <div>
                        <p className="font-semibold text-white mb-2">Open Food Com:</p>
                        <ul className="space-y-1 text-sm">
                          <li>• Mesa de Antepastos</li>
                          <li>• Ilhas Gastrônomicas</li>
                          <li>• Lanche da Madrugada e Sobremesas</li>
                          <li>• Menus Impressos</li>
                          <li>• Placas Personalizadas Para Identificação dos Buffets</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-orange-400 mb-4">Sonorização e Iluminação</h4>
                    <div className="grid md:grid-cols-2 gap-4 text-slate-300">
                      <ul className="space-y-1 text-sm">
                        <li>• Estrutura Completa de Sonorização</li>
                        <li>• Estrutura Completa de Iluminação (Pista, Cênica e Pontuação das Mesas) de Todo o Evento</li>
                        <li>• Painel de LED (Projeto Realizado Em Conjunto Com A Comissão)</li>
                      </ul>
                      <ul className="space-y-1 text-sm">
                        <li>• VJ</li>
                        <li>• Iluminador</li>
                  ...
                  {/* Equipe Técnica */}
                  <div>
                    <h4 className="text-xl font-bold text-cyan-400 mb-4">Equipe Técnica</h4>
                    <div className="grid md:grid-cols-2 gap-4 text-slate-300">
                      <div>
                        <ul className="space-y-1 text-sm">
                          <li>• Equipe Coordenação Geral e Gerenciamento Padrão EOM Multifly (6)</li>
                          <li>• Equipe de Montagem, Evento e Desmontagem (4)</li>
                          <li>• Mestre de Cerimônias</li>
                          <li>• Produtor Geral do Evento</li>
                          <li>• Produtor de Palco</li>
                        </ul>
                      </div>
                      <div>
                        <ul className="space-y-1 text-sm">
                          <li>• Equipe de Recepcionistas (12)</li>
                          <li>• Equipe de Seguranças (25)</li>
                          <li>• Equipe de Coordenação de Acesso</li>
                          <li>• Equipe de Limpeza (8)</li>
                          <li>• Fretes</li>
                        </ul>
                      </div>
                    </div>
                  ...
                  {/* Itens Extras */}
                  <div>
                    <h4 className="text-xl font-bold text-pink-400 mb-4">Itens Extras Dentro do Projeto</h4>
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {/* Apoio Completo da Agência */}
                      <div className="bg-slate-700/30 backdrop-blur-md rounded-lg p-6 border border-slate-600/30">
                        <h5 className="font-bold text-white mb-3 text-center">Apoio Completo da Agência 360°</h5>
                        <p className="text-sm text-slate-300 text-center">Para Toda Produção De Conteúdo e Eventos</p>
                        <p className="text-xs text-slate-400 mt-2 text-center">Assessoria - Acompanhamento Durante Todo O Processo De Atendimento Do Projeto e Realização Do Roteiro e Cronograma Da Cerimônia.</p>
                      </div>

                      {/* Suporte em Ações de Arrecadação */}
                      <div className="bg-slate-700/30 backdrop-blur-md rounded-lg p-6 border border-slate-600/30">
                        <h5 className="font-bold text-white mb-3 text-center">Suporte em Todas As Ações De Arrecadação</h5>
                        <p className="text-sm text-slate-300 text-center">Apoio completo para todas as atividades de arrecadação do projeto</p>
                      </div>

                      {/* 1 Drink Não Alcoólico */}
                      <div className="bg-slate-700/30 backdrop-blur-md rounded-lg p-6 border border-slate-600/30">
                        <h5 className="font-bold text-white mb-3 text-center">1 Drink Não Alcoólico Por Formando</h5>
                        <p className="text-sm text-slate-300 text-center">Bebida especial inclusa para cada formando</p>
                      </div>

                      {/* Pulseira de LED */}
                      <div className="bg-slate-700/30 backdrop-blur-md rounded-lg p-6 border border-slate-600/30">
                        <h5 className="font-bold text-white mb-3 text-center">Pulseira de LED para Todos os Formandos</h5>
                        <p className="text-sm text-slate-300 text-center">Identificação especial com tecnologia LED</p>
                      </div>

                      {/* Cabine de Fotos */}
                      <div className="bg-slate-700/30 backdrop-blur-md rounded-lg p-6 border border-slate-600/30">
                        <h5 className="font-bold text-white mb-3 text-center">Cabine de Fotos – Com Acessórios Premium</h5>
                        <p className="text-sm text-slate-300 text-center">Experiência fotográfica completa com acessórios de alta qualidade</p>
                      </div>

                      {/* Bar De Drinks */}
                      <div className="bg-slate-700/30 backdrop-blur-md rounded-lg p-6 border border-slate-600/30">
                        <h5 className="font-bold text-white mb-3 text-center">Bar De Drinks - The Barthenders</h5>
                        <p className="text-sm text-slate-300 text-center">Bar especializado com drinks elaborados</p>
                      </div>

                      {/* Family Day */}
                      <div className="bg-slate-700/30 backdrop-blur-md rounded-lg p-6 border border-slate-600/30">
                        <h5 className="font-bold text-white mb-3 text-center">Family Day Multiplicativa Pet Friendly</h5>
                        <p className="text-sm text-slate-300 text-center">Evento familiar gratuito para formandos e convidados</p>
                        <p className="text-xs text-slate-400 mt-2 text-center">A participação no evento Family Day Multifly Pet Friendly será gratuita para os formandos e seus convidados. No entanto, o acesso às fotografias realizadas durante o evento estará condicionado à aquisição de álbuns fotográficos, que serão ofertados no local.</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="px-6 pb-6 animate-fadeIn">
                    <div className="bg-slate-700/30 backdrop-blur-md rounded-lg p-4 border border-slate-600/30">
                      <div className="space-y-3 text-sm text-slate-300">
                        <p><span className="font-semibold text-white">Baile de Formatura:</span> 03/12/2025 – Quarta-feira – 19h30 às 05h00</p>
                        <p><span className="font-semibold text-white">Local do Evento:</span> Espaço Torres Paraná Clube – Avenida Presidente Kennedy, 2377 – Guaíra – Curitiba.</p>
                  ...
                  <div className="px-6 pb-6 space-y-3 animate-fadeIn">
                    <div className="bg-slate-700/30 backdrop-blur-md rounded-lg p-4 border border-slate-600/30 space-y-3">
                      <div>
                        ...
                        <p className="text-slate-300 text-sm">Vestido Social Longo</p>
              </div>
                      <div>
                        <h4 className="font-bold text-blue-400 mb-2">Formandos:</h4>
                        <p className="text-slate-300 text-sm">Smoking e Gravata Preta</p>
            </div>
                      <div>
