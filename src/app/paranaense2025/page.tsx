    ...
    <div className="min-h-screen bg-slate-900 text-white font-montserrat">
      ...
      <section className="text-center py-16 px-6">
        ...
        <p className="text-slate-300 text-lg md:text-xl max-w-4xl mx-auto mb-12">
          Neste material contemplamos as respostas das principais dúvidas das famílias em relação à Formatura do Terceirão Paranaense 2025.
        </p>
        ...
        <h2 className="text-3xl font-bold text-center mb-12">Eventos da Formatura</h2>
          ...
          {/* Missa */}
            ...
            <div className="flex items-center mb-4">
                <div className="w-8 h-8 bg-yellow-400 rounded-lg flex items-center justify-center mr-3">
                  <img src="/igreja.svg" alt="Igreja" className="w-5 h-5" />
              </div>
              <h3 className="text-xl font-bold">Missa</h3>
              </div>
            <div className="space-y-3">
                  <p className="text-slate-300 text-sm">Celebração religiosa</p>
                  <div className="space-y-3">
              ...
              <p><span className="font-semibold">Local:</span> Santuário Sagrado Coração de Jesus</p>
              </div>
                    <div className="flex items-center">
                      <svg className="w-5 h-5 mr-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p><span className="font-semibold">Endereço:</span> Av. Água Verde, 1018 - Água Verde, Curitiba - PR</p>
              </div>
              </div>
                  <div className="bg-slate-700/30 backdrop-blur-md rounded-lg p-3 mt-4 border border-slate-600/30">
                    <div className="space-y-3">
                      <div className="flex items-center">
                        ...
                        <p><span className="font-semibold text-yellow-400">Convites:</span> 5 convites por formando</p>
                      </div>
                    </div>
              </div>
              </div>
          ...
          <div className="bg-slate-800/40 backdrop-blur-lg rounded-xl p-6 border border-slate-700/50 shadow-xl">
            ...
            <div className="flex items-center">
                  ...
                  <p><span className="font-semibold">Data:</span> 06 de Dezembro de 2025 - Sábado</p>
          </div>
                <div className="flex items-center">
                  <svg className="w-5 h-5 mr-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                ...
                <div className="flex items-center">
                  ...
                  <p><span className="font-semibold">Local:</span> Clube Curitibano</p>
        </div>
                <div className="flex items-center">
                  <svg className="w-5 h-5 mr-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  ...
                  <p><span className="font-semibold">Endereço:</span> Av. Pres. Getúlio Vargas, 2857 - Água Verde, Curitiba - PR</p>
          </div>
        </div>
              <div className="bg-slate-700/30 backdrop-blur-md rounded-lg p-3 mt-4 border border-slate-600/30">
                <div className="space-y-3">
              <div className="flex items-center">
                    ...
                    <p><span className="font-semibold text-yellow-400">Mesas:</span> 4, 5 ou 6 lugares (conforme pacote)</p>
        </div>
        </div>
            </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-slate-800/40 backdrop-blur-lg rounded-xl p-6 border border-slate-700/50 shadow-xl">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 bg-yellow-400 rounded-lg flex items-center justify-center">
                    <img src="/igreja.svg" alt="Igreja" className="w-6 h-6" />
              </div>
              <div>
                    <h3 className="text-2xl font-bold">Missa</h3>
                    <p className="text-yellow-400 font-semibold">Casual</p>
            </div>
          </div>
              ...
              <div>
                    ...
                    <p className="text-slate-300 text-sm leading-relaxed">
                      Camiseta azul <span className="font-semibold text-white">(Ex-Aluno sim, Ex-Marista nunca)</span> e calça jeans.
            </p>
          </div>
        </div>
          </div>
              ...
              <div>
                    ...
                    <p className="text-yellow-400 font-semibold">All Black</p>
            </div>
          </div>
              ...
              <div>
                    ...
                    <p className="text-slate-300 text-sm leading-relaxed">
                      Sob a beca, usar regata, roupas leves, meia calça preta fio 15 e sapato confortável preto <span className="font-semibold text-white">(sem salto em virtude da estrutura do espaço)</span>.
              </p>
              </div>
              ...
              <div>
                    ...
                    <p className="text-slate-300 text-sm leading-relaxed">
                      Sob a beca, usar camiseta, calça social preta, meia preta e sapato preto.
            </p>
          </div>
            ...
            <div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300 text-sm leading-relaxed">
                      <span className="font-semibold text-white">Smoking ou Terno</span> com gravata borboleta azul
                    </p>
              </div>
                  ...
                  <div className="px-6 pb-6 space-y-4 animate-fadeIn">
                    <div className="bg-slate-700/30 backdrop-blur-md rounded-lg p-4 border border-slate-600/30">
                      <h4 className="font-bold text-yellow-400 mb-3 flex items-center gap-2">
                        <img src="/igreja.svg" alt="Igreja" className="w-5 h-5" />
                        Missa Terceirão Paranaense 2025
                      </h4>
                      <div className="space-y-2 text-sm text-slate-300">
                        <p><span className="font-semibold text-white">Data e Horário:</span> 26/11 - Quarta-feira - 19h45</p>
                        <p><span className="font-semibold text-white">Local:</span> Santuário Sagrado Coração de Jesus</p>
                        <p className="text-slate-400">Av. Água Verde, 1018 - Água Verde, Curitiba - PR</p>
        </div>
            </div>
                    ...
                    <div className="bg-slate-700/30 backdrop-blur-md rounded-lg p-4 border border-slate-600/30">
                      <h4 className="font-bold text-yellow-400 mb-3 flex items-center gap-2">
                        ...
                        Colação de Grau Terceirão Paranaense 2025
                      </h4>
                      <div className="space-y-2 text-sm text-slate-300">
                        <p><span className="font-semibold text-white">Data e Horário:</span> 05/12/2025 - Sexta-Feira - 19h30</p>
              ...
              <div className="bg-slate-800/40 backdrop-blur-lg rounded-xl border border-slate-700/50 shadow-xl overflow-hidden">
                ...
                {openFaq === 6 && (
                  <div className="px-6 pb-6 animate-fadeIn">
                    <div className="bg-slate-700/30 backdrop-blur-md rounded-lg p-4 border border-slate-600/30">
                      <p className="text-slate-300 text-sm leading-relaxed">
                        Cada formando terá direito a <span className="font-semibold text-white">07 convites</span>. É imprescindível a apresentação do convite. Em caso de perda ou esquecimento do ingresso, não será permitida a entrada no evento. O formando não precisa apresentar convite para o dia.
                      </p>
              </div>
              </div>
                )}
                ...
                {openFaq === 8 && (
                  <div className="px-6 pb-6 animate-fadeIn">
                    <div className="bg-slate-700/30 backdrop-blur-md rounded-lg p-4 border border-slate-600/30 space-y-3">
                      <p className="text-slate-300 text-sm font-semibold mb-3">Conforme as três opções respectivamente adquiridas:</p>
                      <ul className="space-y-2 text-sm text-slate-300">
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-yellow-400">•</span>
                          <span>Formando + 4 Convidados - Mesa Compartilhada de 5 Lugares</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-yellow-400">•</span>
                          <span>Formando + 5 Convidados - Mesa Compartilhada de 6 Lugares</span>
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              <div className="bg-slate-800/40 backdrop-blur-lg rounded-xl border border-slate-700/50 shadow-xl overflow-hidden">
                ...
                {openFaq === 12 && (
                  <div className="px-6 pb-6 animate-fadeIn">
                    <div className="bg-slate-700/30 backdrop-blur-md rounded-lg p-4 border border-slate-600/30">
                      <p className="text-slate-300 text-sm leading-relaxed">
                        Sim, o local do evento oferece boa acessibilidade para todos os convidados. O espaço conta com rampas e elevadores de acesso a locomoção de pessoas com mobilidade reduzida, garantindo conforto e segurança durante todo o evento. Nossa equipe também estará à disposição para oferecer o suporte necessário, caso surja qualquer necessidade especial.
                      </p>
              </div>
            </div>
                )}
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="text-center">
              ...
              <p className="text-slate-400 text-sm">
                Formatura Terceirão Paranaense 2025
              </p>
